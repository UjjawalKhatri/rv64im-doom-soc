...
{
    TRACE(0x41); // Milestone 0x41: R_InitTextures start
    R_InitTextures ();
    TRACE(0x42); // Milestone 0x42: R_InitTextures complete
    R_InitFlats ();
    TRACE(0x43); // Milestone 0x43: R_InitFlats complete
    R_InitSpriteLumps ();
    TRACE(0x44); // Milestone 0x44: R_InitSpriteLumps complete
    R_InitColormaps ();
    TRACE(0x45); // Milestone 0x45: R_InitColormaps complete
}
